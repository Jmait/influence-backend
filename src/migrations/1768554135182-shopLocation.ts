...
export class ShopLocation1768554135182 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "shops" ADD "locationName" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "shops" ADD "locationLat" numeric(10,7) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "shops" ADD "locationLng" numeric(10,7) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "customers" ADD "deletedAt" TIMESTAMP WITH TIME ZONE`);
        ...
        await queryRunner.query(`ALTER TABLE "customers" ADD "influencerId" uuid NOT NULL`);
    }
